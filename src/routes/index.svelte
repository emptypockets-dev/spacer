<section class="bg-white pb-8 sm:pb-12 lg:pb-12">
	<div class="overflow-hidden lg:relative lg:py-32">
		<div
				...
				<div class="mt-20">
					...
					<div class="mt-6 sm:max-w-xl">
						<h1 class="text-4xl font-extrabold text-gray-900 tracking-tight sm:text-5xl">
							Spaced repetition and active recall are the secret to finally mastering Javascript.
						</h1>
						<p class="mt-6 text-xl text-gray-500">Remember everything that you learn.</p>
					</div>
